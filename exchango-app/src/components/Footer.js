...
const socialLinks = [
  ...
  { 
    name: 'LinkedIn', 
    href: 'https://www.linkedin.com/in/karindragimhan49/',
    icon: (props) => (
       <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    <footer className="bg-slate-900">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 lg:px-8">
        <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
          <div className="pb-6">
            <Link href="/" className="text-sm leading-6 text-slate-300 hover:text-white">Converter</Link>
          </div>
          <div className="pb-6">
            <Link href="/dashboard" className="text-sm leading-6 text-slate-300 hover:text-white">History</Link>
          </div>
          <div className="pb-6">
            <Link href="#converter" className="text-sm leading-6 text-slate-300 hover:text-white">Features</Link>
          </div>
        </nav>
